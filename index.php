<?php
    ...
    if (file_exists($filename)){
        ...
        // pour chaq article je recupere la categorie
        $catmap = array_map(fn($a) => $a['category'], $articles);
        // je crée un tableau associatif qui a pour clé les categories et pour valeurs le nombre d'articles
        ...
        // je cree un tableau associatif qui a pour clé les categories et pour valeurs tous les articles concernant la categorie
